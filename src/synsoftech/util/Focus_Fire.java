        ...
        for (final JTextField t : tf) {
            t.addFocusListener(new FocusListener() {
                ...
                public void focusGained(FocusEvent e) {
                    ...
                    CompoundBorder border = javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(115, 184, 238)), empty);
                    t.setBorder(border);
                }
                ...
                public void focusLost(FocusEvent e) {
                    Border empty = new EmptyBorder(0, 5, 0, 0);
                    CompoundBorder border = javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)), empty);
                    t.setBorder(border);
