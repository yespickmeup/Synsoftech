...
//</editor-fold>
    ...
    private Authenticate(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        getRootPane().setOpaque(false);
        setBackground(new Color(0, 0, 0, 0));
    ...
    private Authenticate myRef;

    private void setThisRef(Authenticate myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Authenticate> dialogContainer = new java.util.HashMap();
    ...
    public static Authenticate create(java.awt.Window parent, boolean modal) {
    ...
    public static Authenticate create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Authenticate dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Authenticate((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Authenticate((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Authenticate dialog = Authenticate.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        tf_username = new Field.Input_w_clear();
        jButton3 = new Button.Default();
        tf_password = new Field.Password();
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/synsoftech/panels/user34.png"))); // NOI18N

        lbl_warning.setText("Login with your credentials");
                ...
                .addGroup(jXPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jXPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jXPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(lbl_warning, javax.swing.GroupLayout.DEFAULT_SIZE, 276, Short.MAX_VALUE)
            ...
            .addGroup(jXPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jXPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jXPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(1, 1, 1)
                        .addComponent(tf_password, javax.swing.GroupLayout.DEFAULT_SIZE, 33, Short.MAX_VALUE))
    ...
    public void do_pass(final JComponent com, String message) {
        ...
        Authenticate.this.setSize(dim.width, dim.height);
